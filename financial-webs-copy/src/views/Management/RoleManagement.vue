    ...
    <div class="box mt20 role-list">
        ...
        >
          <el-form-item label="角色名：" prop="roleName">
            <el-input
              type="text"
              maxlength="15"
              v-model="ruleForm2.roleName"
              style="width: 300px"
              placeholder="请输入角色名(15字以内)"
            ></el-input>
          </el-form-item>
          <el-form-item label="描述：" style="width: 400px" prop="describe">
            <el-input
              type="textarea"
              maxlength="25"
              v-model="ruleForm2.describe"
              :autosize="{ minRows: 2, maxRows: 4}"
              placeholder="请输入描述信息(25字以内)"
            ></el-input>
          </el-form-item>
          <el-form-item label="区域选择：" style="width: 400px" prop="menuId">
      ...
      <el-row>
        <el-table
          ...
          style="width: 100%"
        >
          <el-table-column :show-overflow-tooltip="true" type="index" label="序列" width="60"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="roleName" label="角色名称" width="150"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="describe" label="描述"></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="createBy" label="创建人" width="120"></el-table-column>
          <el-table-column
            ...
            width="200"
          ></el-table-column>
          <el-table-column :show-overflow-tooltip="true" prop="updateBy" label="更改人" width="120"></el-table-column>
          <el-table-column
            :show-overflow-tooltip="true"
            prop="dateUpdated"
            label="更改时间"
          ...
          <el-table-column :show-overflow-tooltip="true" label="操作" width="150">
            <template slot-scope="scope">
              <i
                class="yc-icon yc-icon-assign-authority mr10"
                style="font-size: 20px"
                @click="dialogVisible3=true,roleId=scope.row.id,saveRoleInfo(scope.row)"
              ></i>
              <i
                class="yc-icon yc-icon-edit mr10"
                style="font-size: 20px"
                @click="dialogVisible2=true,roleId=scope.row.id,saveRoleInfo(scope.row)"
              ></i>
              <i
        ...
        >
          <el-form-item label="角色名：" prop="roleName">
            <el-input
              type="text"
              maxlength="15"
              v-model="updateRuleForm2.roleName"
              style="width: 300px"
              placeholder="请输入角色名(15字以内)"
            ></el-input>
          </el-form-item>
          <el-form-item label="描述：" style="width: 400px" prop="describe">
            <el-input
              ...
              maxlength="25"
              :autosize="{ minRows: 2, maxRows: 4}"
              v-model="updateRuleForm2.describe"
              placeholder="请输入描述信息(25字以内)"
            ></el-input>
          </el-form-item>
        </el-form>
...
export default {
  ...
  methods: {
    ...
    checkChange() {
      this.leafCheckArr = this.$refs.addTree.getCheckedKeys();
      let arr = [];
      ...
      this.$refs.addTree.setCheckedKeys([this.oldCheckKey]); // 通过 this.$refs.fileTree.getCheckedNodes()[0]['label'] 可以拿到最后选中的节点的label

      //     this.editForm.folderName = this.$refs.addTree.getCheckedNodes()[0]['label']
    },

    //  不会复用
    checkChange2() {
      this.leafCheckArr = this.$refs.tree.getCheckedKeys();
      let arr = [];
      this.leafCheckArr.forEach((item) => {
        arr.push(item);
      });
      ...
      this.oldCheckKey = arr.join("");
      this.$refs.tree.setCheckedKeys([]);
      this.$refs.tree.setCheckedKeys([this.oldCheckKey]);
    },
  },
  created() {
    this.selectRoleAll();
